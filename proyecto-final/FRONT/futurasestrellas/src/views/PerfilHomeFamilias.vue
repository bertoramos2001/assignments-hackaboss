  ...
  <div>
      ...
      <h1>PERFIL HOME FAMILIAS</h1>
       ...
       <div id="fichaTecnica"> <!--mostramos la informacion general de la familia en pantalla -->
           ...
           <p id="nacimiento"><span class="titulo">Nacimiento Jugador: <br></span> {{formatDate(infoGeneral.fecha_nacimiento)}}</p>
           <p id="clubActual"><span class="titulo">Club Actual:</span> <br>{{infoGeneral.club_actual}}</p>
           <p id="categoria"><span class="titulo">Categoría:</span> <br>{{infoGeneral.categoria}}</p>
           <p id="posicionPrincipal"><span class="titulo">Posición principal:</span> <br>{{infoGeneral.posicion_principal}}</p>
           <p id="piernaBuena"><span class="titulo">Pierna Buena:</span> <br>{{infoGeneral.pierna_buena}}</p>
       </div>
